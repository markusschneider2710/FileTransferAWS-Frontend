...
function validateStoreProps(props) {
    ...
    const deprecatedProps = templateJoin(DEPRECATED_PROP_KEYS.filter((key) => !!props[key]), template);
...
export { CHANGED_MODE, CONLICTING_PROPS, DEPRECATED_PROPS, DEPRECATED_PROPS_AND_CONFLICTING, DEPRECATED_SUFFIX, MISSING_REQUIRED, READONLY, validateStoreProps as default };
