...
import type { AWSTemporaryCredentials, LocationCredentialsProvider, LocationCredentials } from '../../storage-internal';
...
export type GetLocationCredentials = (input: GetLocationCredentialsInput) => Promise<GetLocationCredentialsOutput>;
