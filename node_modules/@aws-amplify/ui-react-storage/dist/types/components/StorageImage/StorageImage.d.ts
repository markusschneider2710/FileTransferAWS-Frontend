...
export declare const StorageImage: ({ accessLevel, bucket, className, fallbackSrc, identityId, imgKey, path, loadingElement, onStorageGetError, onGetUrlError, validateObjectExistence, ...rest }: StorageImageProps | StorageImagePathProps) => React.JSX.Element | null;
