import { AnyFunction, AssignAction, Assigner, BaseActionObject, Compute, EventObject, MachineConfig, Prop, PropertyAssigner, StateMachine, InternalMachineOptions, ServiceMap } from 'xstate/lib/types';
import { ResolveTypegenMeta, TypegenConstraint, TypegenDisabled } from 'xstate/lib/typegenTypes';
